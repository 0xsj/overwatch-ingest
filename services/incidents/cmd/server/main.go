...
import (
	...
	"github.com/0xsj/scout/services/incidents/config"
)
...
func main() {
	...
	// Log startup
	appLogger.Info("incidents server starting",
		"port", cfg.Port(),
	...
	appLogger.Info("incidents server running",
		"port", cfg.Port(),
	...
	appLogger.Info("incidents server stopped")
}