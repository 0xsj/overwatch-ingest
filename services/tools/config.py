"""Configuration for Tools service."""
...
@dataclass
class Config:
    """Complete configuration for Tools service."""
...
def load(use_prefix: bool = False) -> Config:
    ...
    Args:
        use_prefix: If True, use TOOLS_ prefix. If False, no prefix.
    ...
    """
    prefix = "TOOLS_" if use_prefix else ""
    
    def key(name: str) -> str:
        return prefix + name
    
    # Application config
    port = load_port_optional(key("PORT"), 8083)
